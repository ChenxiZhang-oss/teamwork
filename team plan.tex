% Beamer deck: Midterm Research Plan (plan-based, English only, 12 slides)
...
% ---- Footline: title + date + frame numbers (NO author) ----
\makeatletter
...
\author{Team Name} % kept for title slide; footline template excludes author
